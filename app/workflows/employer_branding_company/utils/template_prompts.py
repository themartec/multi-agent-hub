template = {
    'employee_spotlight': {
        ...
        - Check if the current message or ongoing task already contains/involves employee story content
...
- Structure for readability and engagement"""
    ...
    'mini_blog_post':{
        ...
        'instruction': """Start by greeting user: "Got something to share, like a link to a published blog or advocate responses? Just share the content and I’ll help turn it into a great social post. I can tailor the content to each platform like LinkedIn, Facebook and Instagram"
        \nInputs (if not provided yet):
        - The source content
        - Who the post is from
        - Intended audience
        - Platform, desired tone
